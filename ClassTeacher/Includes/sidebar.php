 <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center bg-gradient-primary justify-content-center" href="index.php" style="border-top: 2px solid black; border-right: none; border-left: 2px solid black; border-bottom: 2px solid black; background: linear-gradient(to bottom right, #FFD400);">
