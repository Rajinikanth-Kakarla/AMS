...
<head>
  ...
  <style>
  /* Body and general UI */
  body, .form-control, .card-body, .breadcrumb, table, select, input, label {
  ...
  /* Buttons */
  .btn-primary {
    background: linear-gradient(45deg, #FFD400, #FFDD3C, #FFEA61, #FFF192, #FFFFB7) !important;
    border: none !important;
    color: black !important;
  }

  .btn-primary:hover {
    background: linear-gradient(45deg, #FFF192, #FFEA61, #FFDD3C, #FFD400) !important;
    color: #fff !important;
  }
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-black">View Student Attendance</h6>
                  <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-black">Class Attendance</h6>
                </div>
                    ...
                    <tbody>
                      ...
                      if (isset($_POST['view'])) {
                        ...
                        if ($type == "2") {
                          ...
                          $query = "..."; // Add your original query here
                        }
                        if ($type == "3") {
                        ...
                        if ($rs->num_rows > 0) {
                          ...
                          while ($rows = $rs->fetch_assoc()) {
                            ...
                            $colour = $status == 'Present' ? '#00FF00' : '#FF0000';
                            echo "<tr>
                                    <td>" . ++$sn . "</td>
